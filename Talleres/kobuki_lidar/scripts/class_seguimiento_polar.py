...
class POLAR:  
    ...
    def __init__(self):
        ...
        self.pub1 = rospy.Publisher("/vel_order",Twist,queue_size=50)
        ...
        rospy.Subscriber("/Meta",Bool,self.callback_meta)
